...
def _initialize_distributed(get_embedding_ranks, get_position_embedding_ranks, store):
    ...
    if torch.distributed.is_initialized():
        ...
        if _use_torchcomms_enabled() and device_id is not None:
            ...
            # forces that creation now, sidestepping the intermittent
            # init-time hang documented in pytorch/pytorch#153960 (followup
            # to #129147). Cheap insurance — one collective at boot.
