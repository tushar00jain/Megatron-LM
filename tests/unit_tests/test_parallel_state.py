...
def test_expert_all_gather_group():
    ...
    # by an eager new_group: new_group drives non-member ranks through
    # performNocolorSplit, which not every cuda backend implements, and
    # hardcoding backend='nccl' would stop the child following the world PG.
